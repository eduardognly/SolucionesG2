...
const WHATSAPP_AGENDA = WA_BASE + encodeURIComponent('Hola Soluciones G2, tengo un restaurante y me interesa agendar una llamada de 15 minutos. ¿Cuándo tienen disponibilidad?')
const WHATSAPP_URL = WA_BASE + encodeURIComponent('Hola Soluciones G2, tengo un restaurante y quisiera conocer sus soluciones. ¿Podemos hablar?')

const problemas = [
  {
    icono: '📋',
    titulo: 'Comandas en papel y errores de pedido',
    descripcion: 'Tickets perdidos, confusiones en cocina y clientes esperando demasiado. Cada error cuesta ventas y reputación.',
    color: '#ff006e',
  },
  {
    icono: '📦',
    titulo: 'Inventario descontrolado',
    descripcion: 'No sabes cuánto tienes de cada ingrediente. La merma se va sin detectar y haces compras de emergencia que rompen tu presupuesto.',
    color: '#bf00ff',
  },
  {
    icono: '📊',
    titulo: 'Sin visibilidad del negocio',
    descripcion: 'No sabes qué platillos son más rentables, en qué horas hay más ventas ni cuánto ganas realmente cada día.',
    color: '#00f5ff',
  },
]
...
const soluciones = [
  {
    ...
    descripcion: 'Tus meseros toman el pedido desde tablet o celular. Llega directo a cocina. Sin papel, sin errores, sin demoras.',
    color: '#00f5ff',
  },
  {
    icono: '📦',
    titulo: 'Control de inventario en tiempo real',
    descripcion: 'Sabe exactamente cuánto tienes, cuándo pedir y cuánto se pierde. Alertas automáticas de mínimos.',
    color: '#00ff88',
  },
  {
    icono: '📡',
    titulo: 'Red WiFi profesional para tu local',
    descripcion: 'Red estable para tus sistemas de punto de venta, comandas y cámaras. WiFi separado para clientes.',
    color: '#bf00ff',
  },
  {
    icono: '📷',
    titulo: 'Cámaras de seguridad',
    descripcion: 'Vigila caja, cocina y áreas de servicio desde tu celular en cualquier momento. Grabación continua.',
    color: '#ff006e',
  },
]
...
export default function Restaurantes() {
  ...
  return (
    <>
      <Helmet>
        <title>Sistema para Restaurantes en CDMX | Soluciones G2</title>
        <meta name="description" content="Digitaliza tu restaurante en CDMX. Sistema de comandas, control de inventario, red WiFi y cámaras de seguridad a la medida. Sin mensualidades de ERP." />
        <link rel="canonical" href="https://solucionesg2.com/restaurantes" />
        <meta property="og:title" content="Sistema para Restaurantes en CDMX | Soluciones G2" />
        <meta property="og:description" content="Digitaliza tu restaurante con sistema de comandas, control de inventario, red WiFi y cámaras. Software a la medida en CDMX." />
        <meta property="og:url" content="https://solucionesg2.com/restaurantes" />
      </Helmet>
      ...
      <div style={{ background: 'var(--bg-primary, #050b1a)', minHeight: '100vh', color: 'var(--text-primary, #e2e8f0)' }}>
        ...
        <nav style={{
          ...
          <a
            ...
            onClick={() => trackWhatsApp('restaurantes-nav')}
            style={{
        ...
        <section style={{
          ...
          background: 'radial-gradient(ellipse 80% 60% at 50% 0%, rgba(0,245,255,0.06) 0%, transparent 70%), radial-gradient(ellipse 60% 40% at 80% 50%, rgba(191,0,255,0.05) 0%, transparent 60%)',
        }}>
          <div style={{ maxWidth: '760px', textAlign: 'center' }}>
            <motion.div
              ...
              style={{
                ...
                fontFamily: 'var(--font-mono)', fontSize: '0.78rem', color: '#00f5ff',
              }}
            >
              <span>🍽️</span> Para restaurantes en CDMX y Estado de México
            </motion.div>
            ...
            >
              Olvídate de las comandas en papel y el inventario descontrolado. Te ayudamos a digitalizar
              tu operación sin complicaciones ni mensualidades de ERP.
            </motion.p>
            ...
            >
              <a
                ...
                style={{
                  ...
                  background: 'linear-gradient(135deg, #00f5ff, #bf00ff)',
                  color: '#050b1a', textDecoration: 'none',
                  fontWeight: 700, fontSize: '0.95rem',
                  boxShadow: '0 0 30px rgba(0, 245, 255, 0.25)',
                }}
                onClick={() => trackWhatsApp('restaurantes-hero-agenda')}
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => trackWhatsApp('restaurantes-hero-wa')}
                style={{
                  display: 'inline-flex', alignItems: 'center', gap: '8px',
                  padding: '14px 28px', borderRadius: '10px',
          ...
          <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
            ...
            <motion.p
              ...
              style={{
                ...
                marginBottom: '56px', fontSize: '0.95rem',
              }}
            >
              Son los más comunes en restaurantes que aún no han digitalizado su operación.
            </motion.p>
        ...
        {/* Soluciones */}
        <section style={{ padding: '80px 24px', background: 'rgba(0,245,255,0.02)' }} ref={refSoluciones}>
          <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
            <motion.h2
              initial={{ opacity: 0, y: 30 }}
            ...
            <motion.p
              initial={{ opacity: 0 }}
              animate={solucionesVisible ? { opacity: 1 } : {}}
              transition={{ duration: 0.6, delay: 0.1 }}
              style={{
                textAlign: 'center', color: 'var(--text-muted, #94a3b8)',
                marginBottom: '56px', fontSize: '0.95rem',
            ...
            >
              Todo lo que tu restaurante necesita, instalado y configurado en sitio en CDMX.
            </motion.p>
          ...
          <div style={{ maxWidth: '700px', margin: '0 auto', textAlign: 'center' }}>
            <div style={{
              ...
              <p style={{ color: 'var(--text-muted, #94a3b8)', marginBottom: '32px', fontSize: '0.95rem', lineHeight: 1.7 }}>
                La llamada de 15 minutos es gratis y sin compromiso. Te contamos exactamente cómo podemos ayudarte.
              </p>
              <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' }}>
                <a
                  ...
                  onClick={() => trackWhatsApp('restaurantes-cta')}
                >
                ...
                <a
                  ...
                  style={{
                    ...
                    color: '#00f5ff', textDecoration: 'none', fontWeight: 600, fontSize: '0.9rem',
                  }}
                >
                  Enviar mensaje
                </a>
              ...
              <form onSubmit={enviar} noValidate>
                ...
                <div style={{ marginBottom: '28px' }}>
                  ...
                  <textarea
                    ...
                    onBlur={() => setEnfocado(null)}
                    placeholder="Cuéntanos cuántas mesas tiene tu restaurante, qué problemas tienes hoy y qué te gustaría mejorar..."
                    required
                    rows={5}
